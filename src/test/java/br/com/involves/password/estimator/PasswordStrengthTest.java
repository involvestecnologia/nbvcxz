...
import br.com.involves.password.estimator.PasswordStrength;
...
import br.com.involves.password.estimator.resources.DictionaryBuilder;
...
public class PasswordStrengthTest
{
    ...
    public void testExcludeDictionary()
    {
        ...
        final PasswordStrength nbvcxz = new PasswordStrength(configuration);
        try
        {
            password = "halshauser";
    ...
    public void testEstimate()
    {
        ...
        Result result;
        final double tolerance = 0.00000001;
        final PasswordStrength nbvcxz = new PasswordStrength();
