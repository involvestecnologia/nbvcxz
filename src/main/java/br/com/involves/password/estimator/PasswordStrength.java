package br.com.involves.password.estimator;
...
import br.com.involves.password.estimator.resources.Generator;
import br.com.involves.password.estimator.scoring.Result;
import br.com.involves.password.estimator.scoring.TimeEstimate;
import br.com.involves.password.estimator.utils.MapStringLongComparator;
...
public class PasswordStrength
{
     ...
     */
    public PasswordStrength(Configuration configuration)
    {
    ...
    public static void main(String... args)
    {
        ...
        PasswordStrength nbvcxz = new PasswordStrength(configuration);
    ...
    private static void printGenerationInfo(final PasswordStrength nbvcxz, final String password)
    {
        ResourceBundle resourceBundle = ResourceBundle.getBundle("main", nbvcxz.getConfiguration().getLocale());
        System.out.println("----------------------------------------------------------");
    ...
    private static void printEstimationInfo(final PasswordStrength nbvcxz, final String password)
    {
        ResourceBundle resourceBundle = ResourceBundle.getBundle("main", nbvcxz.getConfiguration().getLocale());
